...
* PowderGrams are updated daily on [the PG-Map](https://map.powderguide.com/?b=&c%5Blng%5D=-145.1017&c%5Blat%5D=62.0811&date=today&day=024&maskStr=nomask&model=&p=0&t=&varName=snow_gsp_noJnsd__lsfwe&z=4.88)
...
*eventually the team decided to go fast and avoid the winds forecasted. They took their chance, favoring calm winds above mixed cloudiness, and summited. During their ascent I kept on updating them, using the WRF-HRRR-AK, which is refreshed 3-hourly, and assuring them in regards of the threat that were the winds arriving. *


# Bolivian First Descents by Schulz et al.

Alongside the North-American adventures, a team around Malte Schulz opted for steep ski descents in the Bolivian Andes, in late April / early May 2026. Within not even 2 weeks the made quite likely the first ski / snowboard descents of
